...
public class PracticeQuestionsCh5 {
	 ...
	 * 
	 * Since int is 32-bit in Java, we use int for M and N. The solution is 2 stepped. First we clear out the bits j
	 * through i from N. Then we do a bitwise OR of M and N.
	 */
