	...
	public static void main(String[] args) {
		try {
			JAXBContext jc = JAXBContext
					.newInstance("name.abhijitsarkar.learning.xml.jaxb.basic.unmarshalvalidate.generated");
			...
			try {
				Schema schema = sf.newSchema(Driver.class
						.getResource("/unmarshal-validate/po.xsd"));
				u.setSchema(schema);
			...
			Object poe = u.unmarshal(Driver.class.getResource("/unmarshal-validate/po.xml"));
