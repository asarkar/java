...
import name.abhijitsarkar.learning.lucene.mavenrepo.MavenPOMAnalyzer;
...
public class MavenPOMAnalyzerTest {
    ...
    public void testMavenPOMAnalyzer() throws IOException {
        String input = "<project xmlns=\"http://maven.apache.org/POM/4.0.0\" "
                ...
                + "<parent>\n"
                + "<groupId>name.abhijitsarkar.learning.lucene</groupId>\n"
        ...
        String[] output = new String[] { "name.abhijitsarkar.learning.lucene",
                "lucene-learning" };
