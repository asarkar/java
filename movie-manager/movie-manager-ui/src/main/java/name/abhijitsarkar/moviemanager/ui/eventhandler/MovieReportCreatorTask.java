package name.abhijitsarkar.moviemanager.ui.eventhandler;

import static name.abhijitsarkar.moviemanager.ui.util.UIUtil.cleanup;
import static name.abhijitsarkar.moviemanager.ui.util.UIUtil.sleepForSomeTime;
...
import name.abhijitsarkar.moviemanager.delegate.MovieManager;
import name.abhijitsarkar.moviemanager.domain.Movie;
import name.abhijitsarkar.moviemanager.domain.Summary;
import name.abhijitsarkar.moviemanager.ui.AnimatedFrame;
import name.abhijitsarkar.moviemanager.util.ConfigManager;
