...
public class UserSettingsPanel extends javax.swing.JPanel {
    ...
    public UserSettingsPanel(Window w) {
        ...
        try {
            ...
            String userSettingsIO = prop.getProperty(
                    ConfigManager.USER_SETTINGS_IO_KEY);

            if (ConfigManager.USER_SETTINGS_IO_NO_PREF_VALUE.equals(
                    userSettingsIO)) {
                noPreferenceRadioButton.setSelected(true);
            } else if (ConfigManager.USER_SETTINGS_IO_START_WITH_VALUE.equals(
                    userSettingsIO)) {
                alwaysStartWithRadioButton.setSelected(true);

                alwaysStartWithField.setText(prop.getProperty(
                        ConfigManager.USER_SETTINGS_IO_START_WITH_KEY));
            } else {
            ...
            JOptionPane.showMessageDialog(null,
                    "Could not retrieve user preferences.",
                    "Warning",
    ...
    private void initComponents() {
        ...
        inputOutputLabel.setText("Input & Output directory (requires restart):");
        ...
        alwaysStartWithRadioButton.addItemListener(new java.awt.event.ItemListener() {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addComponent(noPreferenceRadioButton, javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(alwaysStartWithRadioButton, javax.swing.GroupLayout.Alignment.LEADING))
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addComponent(saveButton)
                                    .addComponent(alwaysStartWithField, javax.swing.GroupLayout.PREFERRED_SIZE, 279, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(18, 18, 18)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(closeButton)
                                    .addComponent(browseButton, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE))))))
                .addContainerGap(26, Short.MAX_VALUE))
        );

        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {browseButton, closeButton, saveButton});
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(alwaysStartWithField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(closeButton)
                    .addComponent(saveButton))
        ...
        layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {alwaysStartWithField, browseButton});
    ...
    private void alwaysStartWithRadioButtonItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_alwaysStartWithRadioButtonItemStateChanged
