...
public class ConfigManager {
    ...
    public static final String USER_SETTINGS_IO_START_WITH_KEY =
            "user.settings.inputOutput.startWith";
    public static final String USER_SETTINGS_IO_LAST_INPUT_DIR_KEY =
            "user.settings.inputOutput.inputDir";
    public static final String USER_SETTINGS_IO_LAST_OUTPUT_DIR_KEY =
            "user.settings.inputOutput.outputDir";
    ...
    private static final File CONFIG_DIR = new File(System.getProperty("user.home")
            + File.separator + BASE_DIR + File.separator + "configuration");
...
//        }
    ...
    public static Properties getConfigProperties() throws FileNotFoundException,
            IOException {
    ...
    public static String getLastOpenedInputDir() {
        ...
        try {
            ...
            if (USER_SETTINGS_IO_START_WITH_VALUE.equals(userSettingsIO)) {
                lastOpenedInputDir = prop.getProperty(
                        USER_SETTINGS_IO_START_WITH_KEY);
            } else if (USER_SETTINGS_IO_RMBR_LAST_VALUE.equals(userSettingsIO)) {
                lastOpenedInputDir = prop.getProperty(
                        USER_SETTINGS_IO_LAST_INPUT_DIR_KEY);
            }
    ...
    public static void setLastOpenedInputDir(String lastOpenedInputDir) {
        try {
            Properties prop = getConfigProperties();
            prop.put(USER_SETTINGS_IO_LAST_INPUT_DIR_KEY,
                    lastOpenedInputDir);
            ...
            ex.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Could not save as last opened input directory.",
                    "Error",
    ...
    public static String getLastOpenedOutputDir() {
        ...
        try {
            ...
            if (USER_SETTINGS_IO_START_WITH_VALUE.equals(userSettingsIO)) {
                lastOpenedOutputDir = prop.getProperty(
                        USER_SETTINGS_IO_START_WITH_KEY);
            } else if (USER_SETTINGS_IO_RMBR_LAST_VALUE.equals(userSettingsIO)) {
                lastOpenedOutputDir = prop.getProperty(
                        USER_SETTINGS_IO_LAST_OUTPUT_DIR_KEY);
            }
    ...
    public static void setLastOpenedOutputDir(String lastOpenedOutputDir) {
        try {
            Properties prop = getConfigProperties();
            prop.put(USER_SETTINGS_IO_LAST_OUTPUT_DIR_KEY,
                    lastOpenedOutputDir);
            ...
            ex.printStackTrace();
            JOptionPane.showMessageDialog(null,
                    "Could not save as last opened output directory.",
                    "Error",
                    JOptionPane.ERROR_MESSAGE);
        }
    }
