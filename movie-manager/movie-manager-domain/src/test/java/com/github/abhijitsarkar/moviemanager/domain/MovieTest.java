...
public class MovieTest {
	...
	movie1 = new Movie("3-10 To Yuma", (short) 2007, ACTION_AND_ADVENTURE,
		2250491151L, ".mkv");
	movie2 = new Movie("Body of Lies", (short) 2008, ACTION_AND_ADVENTURE,
		2233486674L, ".mkv");
	movie3 = new Movie(null, (short) 2007, ACTION_AND_ADVENTURE,
		2250491151L, ".mkv");
	movie4 = new Movie("3-10 To Yuma", (short) -1, ACTION_AND_ADVENTURE,
		2250491151L, ".mkv");
	movie5 = new Movie("3-10 To Yuma", (short) 2007, UNKNOWN, 2250491151L,
		".mkv");
	movie6 = new Movie("3-10 To Yuma", (short) 2007, null, 2250491151L,
		".mkv");
	movie7 = new Movie("3-10 To Yuma", (short) 2007, ACTION_AND_ADVENTURE,
		2250491151L, ".mkv");
    }
	...
	SortedSet<Movie> movieList1 = new TreeSet<Movie>(new MovieComparator<Movie>());
	SortedSet<Movie> movieList2 = new TreeSet<Movie>(new MovieComparator<Movie>());
	SortedSet<Movie> movieList3 = new TreeSet<Movie>(new MovieComparator<Movie>());
